        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Please copy the code below. If you didn't create an account with <a href="https://blogdesire.com">Paste</a>, you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end copy -->
                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor=rgba(255, 255, 255, 0.53) style="border-radius: 6px;">
                          <div style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; background-color: grey; color: #ffffff; text-decoration: none; border-radius: 6px;">
                            <div>${code}</div>
                          </div>
                        </td>
                      </tr>
...
export const acceptanceEmailHTML = ({ userName, jobTitle, companyName }) => {
  return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; background: white; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px #ccc;">
...
export const rejectionEmailHTML = ({ userName, jobTitle, companyName }) => {
  return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; background: white; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px #ccc;">
        <h2 style="color: #d32f2f;">Thank You for Your Application, ${userName}</h2>
        <p>We appreciate your interest in the <strong>${jobTitle}</strong> position at <strong>${companyName}</strong>.</p>
        <p>After careful review, we regret to inform you that we have chosen to proceed with another candidate at this time.</p>
        <p>However, we truly appreciate your effort and encourage you to apply for future opportunities with us.</p>
